...
assert remove_duplicates_set("Leonie") == "Leoni"
assert remove_duplicates_set("Hannah") == "Hanh"
assert remove_duplicates_set("Fiona") == "Fiona"
...
def gem_counting(stones, gems):
    """
    This function will calculate how many stones you have.
    ...
    Parameters:
    - stones (string): The string which describes the stones that you collected.
    - gems (string): The string that include the gems.

    Returns:
    - (int): The number of stones that you have collected that are gems
    """
...
assert gem_counting("abcd", "a") == 1
assert gem_counting("abcd", "abcd") == 4
...
and the students accomendation. (Fake news but best wishes 😄)Please!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def students_id(ids):
    """
    This function returns the number of diffrent student that use the shuttle.
    ...
    Returns:
    - (int): The number of diffrent student using the shullte
    """
    students_shuttle = 0
    students_seen = set()
    for id in ids:
...
def word_frequency(paragraph):
    ...
    Parameters:
    - paragraph (lst): A list of words.

    Returns:
    - (dict): The occurences of each different word.    
    """
    words = []
...
assert word_frequency("How are you") == {'How': 1, 'are': 1, 'you': 1}
