...
Your Name 😍: Leonie Mundwiler 100177939
...
#---------------------------------------------------------
# Exercise 1 - Read the following code, try to guess the output, and run it to verify your guess. I think it's 2(maybe also 4,6,8 and 10 but I'm not shure) and I looked at the output and it was 2.
...
my_name = "Leonie" # Change to your name
my_github_account = "https://github.com/leoniemundwilerCapu" # Change to your GitHub account
my_hobby = "crochet stuffed animals(especially dinos) as well as flowers and dance" # Change to your hobby
hours_coding_per_week = "3-4" # How many hours per week would you like to devote to learn coding?
...
project_another_interested = project_types[2] # Try to change the index from 3 to 4, and run the program :) the first one is 0 😄


print(f"""
Hi {my_instructor_name},

I am {my_name}. I like to {my_hobby}.

My experience level in coding is {my_coding_experience}, at least I think, but I have a good understanding of these things.
